...
public  PlaylistResponse(String name,String id,String artimg, String userassociated){this.playid=id; this.artimg=artimg; this.playname=name;
    }
    public  PlaylistResponse(String name,String id, String userassociated){this.playid=id; this.artimg=artimg; this.playname=name;
    }
